#ifndef _FILE_SDU_QUEUE_H_
#define _FILE_SDU_QUEUE_H_
...
#define SDU_QUEUE_EQUEUEFULL    2 // Queue was/is full and can't take more elements
#define SDU_QUEUE_EQUEUEEMPTY   3 // Queue was/is empty



/** @brief          Static queue that holds references pointing at SDUs (os_mbuf).
 *                  So this queue doen't contain the data itself.
 *                  It can only be used as addition to manage the order of SDUs
 *                  which usually should be stored in a os_mbuf_pool (os/os_mbuf.h).
 */
typedef struct{
...
/** @brief          For debugging only. Prints the state of a sdu_queue.
 */
void sdu_queue_print(sdu_queue* queue);



#endif /* !_FILE_SDU_QUEUE_H_ */